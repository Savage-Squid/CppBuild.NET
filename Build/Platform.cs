...
namespace CppBuild.Build
{
    ...
    public abstract class Platform
    {
        ...
        public static TargetPlatform BuildTargetPlatform
        {
            get
            {
                if (_buildPlatform == null)
                {
                    ...
                    default: throw new NotImplementedException($"Unsupported build platform {platformId}.");
                    }
                }
        ...
        /// <summary>
        /// Gets the <see cref="Platform"/> for a given target platform.
        /// </summary>
        ...
        public static Platform GetPlatform(TargetPlatform targetPlatform, bool nullIfMissing = false)
        {
            ...
            if (nullIfMissing)
                return null;
            throw new Exception($"Platform {targetPlatform} is not supported.");
        }
